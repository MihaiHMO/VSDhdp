...
read_verilog output/synth/vsdmemsoc.AREA_2.nl.v
...
report_checks -path_delay min_max -from [all_registers] -to [all_registers] -fields {nets cap slew input_pins} 
report_tns -fields {nets cap slew input_pins} 
report_wns -fields {nets cap slew input_pins} 
#report_checks -path_delay min_max -endpoint_count 500 -unique_paths_to_endpoint -to mem -fields {nets cap slew input_pins} > reg2reg_500.rpt
#report_checks -path_delay min_max -unique_paths_to_endpoint -to {get_ports mem} -fields {nets cap slew input_pins} > reg2mem_min_max.rpt

#report_checks -path_delay min_max -group_count 1000 -endpoint_count 1000 -unique_paths_to_endpoint -to mem -fields {nets cap slew input_pins} > reg2reg.rpt
